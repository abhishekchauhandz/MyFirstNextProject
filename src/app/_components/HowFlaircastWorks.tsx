...
const HowFlaircastWorks = () => {
  return (
    <section id='how-flaircast-works' className='how-flaircast-works padd-section'>
        ...
        <div className='section-title'>
          ...
          <div className='article'>
            ...
            <div className='article-text content'>
              ...
              <p>Access Flaircast from your desktop, laptop, tablet or smartphone.</p>
              <p>Flaircast is designed to convert—we&apos;ve spent five years testing placement and messaging.</p>
              <p>Flaircast is powered by Android—one of the most respected computer platforms in the world.</p>
              <p>24/7/365 support is available to you if you ever need it.</p>
              <p>IT&apos;S THAT SIMPLE….IT IS AN EASY SELF INSTALL PROCESS…. COMPLETE IN MINUTES.</p>
              <p>Take control of your in-house messaging with Flaircast today!</p>
            </div>
          </div>
        </div>
      </div>
...
export default HowFlaircastWorks;
